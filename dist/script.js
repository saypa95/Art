...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_forms__WEBPACK_IMPORTED_MODULE_2__["default"])(calcFormState);
  Object(_modules_mask__WEBPACK_IMPORTED_MODULE_3__["default"])("[name='phone']");
  Object(_modules_checkTextInputs__WEBPACK_IMPORTED_MODULE_4__["default"])('[name="name"]');
  Object(_modules_checkTextInputs__WEBPACK_IMPORTED_MODULE_4__["default"])('[name="message"]');
  Object(_modules_showMoreStyles__WEBPACK_IMPORTED_MODULE_5__["default"])('.button-styles', '.styles .row');
  Object(_modules_calc__WEBPACK_IMPORTED_MODULE_6__["default"])('#size', '#material', '#options', '.promocode', '.calc-price', calcFormState);
  ...
  Object(_modules_accordion__WEBPACK_IMPORTED_MODULE_9__["default"])("#accordion");
...
var accordion = function accordion(accordionSelector) {
  ...
  accordion.addEventListener("click", function (e) {
    ...
    if (target.classList.contains("accordion-heading")) {
      ...
      var _next = target.parentNode.nextElementSibling;

      _next.classList.toggle("active");

      _next.classList.add("animated", "fadeIn");
    }
  });
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var burger = function burger(burgerSelctor, menuSelector) {
  var burgerBtn = document.querySelector(burgerSelctor),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var calc = function calc(sizeSelector, materialSelector, optionsSelector, promocodSelector, resultSelector, state) {
...
var filter = function filter() {
  ...
  function hideTabs() {
    portfolioTitles.forEach(function (item) {
      item.classList.remove("active");
    });
    portfolioBlocks.forEach(function (item) {
  ...
  function showTabs() {
    var className = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "all";
...
var forms = function forms(state) {
  ...
  forms.forEach(function (form) {
    form.addEventListener("submit", function (e) {
      ...
      var formData = new FormData(form); // formData.append('image', form.querySelector("[name='upload']").files[0]);
...
var modals = function modals() {
  ...
  var popupConsultationShowed = false;
...
var showMoreStyles = function showMoreStyles(trigger, wrapper) {
  ...
  btn.addEventListener("click", function () {
    Object(_services_requests__WEBPACK_IMPORTED_MODULE_3__["getResources"])("http://localhost:3000/styles").then(function (response) {
      return createCards(response);
...
var slider = function slider(slideSelector, direction, prev, next) {
  var slideIndex = 0,
      paused = false;
